                    ...
                    {productData.product.variants?.length > 0 ? (
                      productData.product.variants.map((variant) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            <span
                              className={`px-2 py-1 rounded-md text-[10px] font-bold ${variant.stock > 10 ? "bg-green-50 text-green-600" : "bg-red-50 text-red-600"}`}
                            >
                              {variant.stock} Left
                            </span>
                          </td>
                          ...
                          <td className="px-6 py-4 text-right flex gap-2">
                            <Link
                              href={`/admin/products/variants/edit?variantId=${variant._id}`}
                              className="text-gray-400 hover:text-blue-600"
                            >
                              <Edit3
                                className="bg-purple-600 text-gray-100 rounded p-1"
                                size={24}
                              />
                            </Link>
                            <button
                            ...
                            >
                              <Trash2
                                className="bg-red-600 text-gray-100 rounded px-1 py-0.5"
                                size={24}
                              />
                            </button>
                          </td>
